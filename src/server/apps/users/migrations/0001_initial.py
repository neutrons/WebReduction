# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-27 14:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ipts', models.ForeignKey(help_text='This IPTS will be used to find your data on ICat.         If you leave it empty the ICat lookup will not work!', null=True, on_delete=django.db.models.deletion.CASCADE, to='auth.Group')),
