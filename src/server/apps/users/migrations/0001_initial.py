...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('experiment_number', models.IntegerField(default=0, help_text='HFIR Experiment Number (expXXX)')),
                ('ipts', models.ForeignKey(blank=True, help_text='This IPTS will be used to find your data on ICat. If you leave it empty the ICat lookup will not work!', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiment_iptss', related_query_name='experiment_ipts', to='auth.Group', verbose_name='Integrated Proposal Tracking System (IPTS) number')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('experiment_number', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='ipts', chained_model_field='ipts', on_delete=django.db.models.deletion.CASCADE, to='users.Experiment')),
                ...
                ('ipts', models.ForeignKey(blank=True, help_text='This IPTS will be used to find your data on ICat. If you leave it empty the ICat lookup will not work!', null=True, on_delete=django.db.models.deletion.CASCADE, to='auth.Group', verbose_name='Integrated Proposal Tracking System (IPTS) number')),
