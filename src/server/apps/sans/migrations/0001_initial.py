# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-05-30 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empty_beam_file', models.CharField(blank=True, help_text='Note that the user can always overwrite this value!', max_length=64, verbose_name='Empty Beam Transmission file')),
                ('beam_center_file', models.CharField(blank=True, help_text='Note that the user can always overwrite this value!', max_length=64, verbose_name='Beam Center file')),
