...
import server.apps.configuration.models.sans_hfir_biosans
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='SansHfirBiosansConfiguration',
            fields=[
                ...
                ('azimuthal_average_binning', models.CharField(help_text="Select a Q range of the form: 'min,-step,max'.             Note that negtive step means log binning.", max_length=128, validators=[server.apps.configuration.models.sans_hfir_biosans.validate_q_range], verbose_name='Q range')),
                ...
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sanshfirbiosansconfiguration_instruments', related_query_name='sanshfirbiosansconfiguration_instrument', to='catalog.Instrument')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sanshfirbiosansconfiguration_users', related_query_name='sanshfirbiosansconfiguration_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='SansHfirGpsansConfiguration',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=256)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ...
                ('empty_beam_file', models.CharField(blank=True, help_text='Note that the user can always overwrite this value!', max_length=256, verbose_name='Empty Beam Transmission file')),
                ('beam_center_file', models.CharField(blank=True, help_text='Note that the user can always overwrite this value!', max_length=256, verbose_name='Beam Center file')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sanshfirgpsansconfiguration_instruments', related_query_name='sanshfirgpsansconfiguration_instrument', to='catalog.Instrument')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sanshfirgpsansconfiguration_users', related_query_name='sanshfirgpsansconfiguration_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wavelength', models.DecimalField(blank=True, decimal_places=2, help_text='If empty uses the value set in the data file.', max_digits=4, null=True, verbose_name='Wavelength (Å)')),
                ('wavelength_spread', models.DecimalField(blank=True, decimal_places=2, help_text='If empty uses the value set in the data file.', max_digits=3, null=True, verbose_name='Wavelength Spread (%)')),
                ('configuration_file', models.CharField(blank=True, help_text='Server side file path', max_length=256)),
