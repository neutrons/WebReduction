# Generated by Django 2.0.4 on 2018-05-15 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('e_min_fraction', models.DecimalField(decimal_places=2, help_text='Minimum energy fraction.', max_digits=4, verbose_name='Eₘᵢₙ fraction')),
                ('e_max_fraction', models.DecimalField(decimal_places=2, help_text='Maximum of energy fraction.', max_digits=4, verbose_name='Eₘₐₓ fraction')),
                ('e_step', models.DecimalField(decimal_places=2, help_text='Energy step in meV.', max_digits=4, verbose_name='E step (meV)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configurations', related_query_name='configuration', to='configuration.ConfigurationHYSPEC')),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
