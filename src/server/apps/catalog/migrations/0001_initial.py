    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filename_prefix', models.CharField(blank=True, help_text='Prefix for file name. E.g. HFIR uses the instrument name', max_length=256, verbose_name='filename prefix')),
