# Generated by Django 2.0.4 on 2018-05-16 21:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script_execution_path', models.CharField(max_length=256)),
                ('script', models.TextField(blank=True, help_text='Python script generated from the reduction entry.         If the script was generated already just shows it!')),
                ('ub_a', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='a')),
                ('ub_b', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='b')),
                ('ub_c', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='c')),
                ('ub_alpha', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='\\(\t\\alpha \\)')),
                ('ub_beta', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='\\(\t\\beta \\)')),
                ('ub_gamma', models.DecimalField(blank=True, decimal_places=4, max_digits=8, verbose_name='\\(\t\\gamma \\)')),
