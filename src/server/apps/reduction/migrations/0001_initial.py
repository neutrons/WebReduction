# Generated by Django 2.0.5 on 2018-05-22 19:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_type', models.IntegerField(choices=[(1, 'Copy script and execute'), (2, 'Copy script'), (3, 'Copy script to autoreduction')], default=1, help_text='For auto reduction copy only the script. If you have previledges you can copy the script to autoreduction.')),
