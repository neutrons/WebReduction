    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script_execution_path', models.CharField(max_length=256)),
                ('script', models.TextField(blank=True, help_text='Python script generated from the reduction entry.         If the script was generated already just shows it!')),
                ('ub_a', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='a')),
                ('ub_b', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='b')),
                ('ub_c', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='c')),
                ('ub_alpha', models.IntegerField(verbose_name='alpha')),
                ('ub_beta', models.IntegerField(verbose_name='beta')),
                ('ub_gamma', models.IntegerField(verbose_name='gamma')),
                ('ub_u_vector', models.CharField(blank=True, help_text='UB u vector.', max_length=12, validators=[django.core.validators.RegexValidator(code='invalid_projection', message='Use: Qx,Qy,Qz', regex='^-?\\d+,-?\\d+,-?\\d+$')], verbose_name='u⃗')),
                ('ub_v_vector', models.CharField(blank=True, help_text='UB v vector.', max_length=12, validators=[django.core.validators.RegexValidator(code='invalid_projection', message='Use: Qx,Qy,Qz', regex='^-?\\d+,-?\\d+,-?\\d+$')], verbose_name='v⃗')),
                ('q1_projection', models.CharField(blank=True, max_length=12, validators=[django.core.validators.RegexValidator(code='invalid_projection', message='Use: Qx,Qy,Qz', regex='^-?\\d+,-?\\d+,-?\\d+$')], verbose_name='Q1 projection')),
                ('q2_projection', models.CharField(blank=True, max_length=12, validators=[django.core.validators.RegexValidator(code='invalid_projection', message='Use: Qx,Qy,Qz', regex='^-?\\d+,-?\\d+,-?\\d+$')], verbose_name='Q2 projection')),
                ('q3_projection', models.CharField(blank=True, max_length=12, validators=[django.core.validators.RegexValidator(code='invalid_projection', message='Use: Qx,Qy,Qz', regex='^-?\\d+,-?\\d+,-?\\d+$')], verbose_name='Q3 projection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(blank=True, help_text='Name of this plot.', max_length=128, verbose_name='Name')),
                ('axis_0', models.CharField(choices=[('Q1', 'Q1'), ('Q2', 'Q2'), ('Q3', 'Q3'), ('DE', 'DeltaE')], max_length=2, verbose_name='Axis')),
                ...
                ('axis_1', models.CharField(choices=[('Q1', 'Q1'), ('Q2', 'Q2'), ('Q3', 'Q3'), ('DE', 'DeltaE')], max_length=2, verbose_name='Axis')),
                ...
                ('axis_2', models.CharField(choices=[('Q1', 'Q1'), ('Q2', 'Q2'), ('Q3', 'Q3'), ('DE', 'DeltaE')], max_length=2, verbose_name='Axis')),
                ...
                ('nsteps_2', models.IntegerField(default=200, verbose_name='#Steps')),
                ('axis_3', models.CharField(choices=[('Q1', 'Q1'), ('Q2', 'Q2'), ('Q3', 'Q3'), ('DE', 'DeltaE')], max_length=2, verbose_name='Axis')),
                ...
                ('nsteps_3', models.IntegerField(default=200, verbose_name='#Steps')),
